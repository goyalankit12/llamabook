    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">LLama Book!!</a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" style="color:#4577ba" href="#services">Features</a>
                    </li>
                    <li>
                        <a class="page-scroll" style="color:#4577ba" href="#portfolio">Users</a>
                    </li>
                    <li>
                        <a class="page-scroll" style="color:#4577ba" href="#about">About</a>
                    </li>
                    <li>
                        <a class="page-scroll" style="color:#4577ba" href="#team">Team</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To Llama Book!</div>
                <div class="intro-heading" style="color:#4851b7" >Connect with Llama across the globe.</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Connecting the World...</h3>
                </div>
            </div>
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa fa-stack-1x fa-inverse"><img style="width: 60%" src="img/logos/chat.png"></img></i>
                    </span>
                    <h4 class="service-heading">Stay Connected</h4>
                    <p class="text-muted">Stay Connected with your Llama friends and talk to them as much as you want to. </p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa fa-stack-1x fa-inverse"><img style="width: 80%" src="img/logos/cam.png"></img></i>
                    </span>
                    <h4 class="service-heading">Share</h4>
                    <p class="text-muted">Share your happy moments with your friends. Let them be the part of your celebrations. </p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Most Followed users on LLama Book.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Beauty</h4>
                        <p class="text-muted">Most Beautiful Llama</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Unbeatable</h4>
                        <p class="text-muted">Strongest Llama</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Geeky</h4>
                        <p class="text-muted">Most Intelligent Llama</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Innocent</h4>
                        <p class="text-muted">Most innocent Llama</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Still Connecting the world.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">We started with the bunch of Llamas across the world with the dream of connecting the Llama across the world.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2010-2011</h4>
                                    <h4 class="subheading">Middle Tier Group</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">We reached the level where we can proudly claim that we are a recognizable name in the field of Llama Social Networking.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2014</h4>
                                    <h4 class="subheading">1 Million</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">We celebrated the success of our 1 million Llama users across the globe.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We are a team of dedicated engineers who are working hard to bring Llama close on social mdeia. </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
 ...
 <!-- About me Section -->
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; AnkitGoyal@ 2016</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2>Beauty</h2>
                                <p class="item-intro text-muted">The most Beautiful Llama.</p>
                                <img class="img-responsive img-centered" src="img/portfolio/1.jpg" alt="">
                                <p>She is the most Beautiful Llama on the social Media. She is the most followed Llama on the social media.  </p>
